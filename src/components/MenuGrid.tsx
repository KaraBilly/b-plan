          ...
          <div className="w-3/4 p-4 flex flex-col justify-between overflow-hidden">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <button
                ...
                className="relative text-sm text-orange-500 hover:text-orange-600 transition-colors"
              >
                添加
                {itemCounts[item.id] > 0 && (
                  <div className="absolute -top-1 -right-1 bg-orange-500 text-white text-[10px] font-bold px-1 py-0.5 rounded-full shadow-md">
                    {itemCounts[item.id]}
                  </div>
                )}
              </button>
